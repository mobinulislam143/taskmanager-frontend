                ...
                <div className='card shadow-md rounded-lg p-5 bg-white'>
                    ...
                    <div className='flex justify-between my-2'>
                        <div className='flex items-center gap-2'><SlCalender />
                            <p>{item.createdAt}</p>
                            <Link className='text-emerald-600'><CiEdit /></Link>
                            <Link className='text-emerald-600'><MdDeleteOutline /></Link>
                        </div>
                        <div className="badge bg-emerald-600 text-white font-semibold">{item.status}</div>
                    </div>
                </div>
            ))}
           </div>     
